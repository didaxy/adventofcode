...
const findLongestWord = str => str.split(/\s/).reduce((max,n) => n.length > max? n.length : max, 0)
console.log(findLongestWord("The quick brown fox jummmmped oveggggggggr the lazy dog"))
