...
let outarr = arr.filter(passes)

function passes(str) {
  if (!str.includes("children") || str.includes("children: 3")) {
    if (!str.includes("cats") || str.includes("cats: 7")) {
      if (!str.includes("samoyeds") || str.includes("samoyeds: 2")) {
        if (!str.includes("pomeranians") || str.includes("pomeranians: 3")) {
          if (!str.includes("akitas") || str.includes("akitas: 0")) {
            if (!str.includes("vizslas") || str.includes("vizslas: 0")) {
              if (!str.includes("goldfish") || str.includes("goldfish: 5")) {
                if (!str.includes("cars") || str.includes("cars: 2")) {
                  if (!str.includes("trees") || str.includes("trees: 3")) {
                    if (!str.includes("perfumes") || str.includes("perfumes: 1")) {
                      return true
                    }
                  }
                }
