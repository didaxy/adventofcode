...
let strippedarr = arr.map(strip)
console.log(`stripped: ${strippedarr}`);


// stripped = arr.map(n => strip(n))
counts = strippedarr.map(n => n.length)
...
console.log(`code - strings = ${newstring.length - total}`);
console.log(`newrep - oldrep = ${puker.length - newstring.length + (2 * arr.length) - 2}`);
function strip(str) {
  str.trim()
...
// console.log(`total strings: ${stripped}`);
// console.log(`total strings length: ${stripped.length}`);
//
// rawr = String.raw({raw: [input]})
...
function tag(strings) {
  ...
  let arr = strings.raw[0].split('\n')
  newstring = arr.join('')
  console.log(`total code: ${newstring}`);
  console.log(`total code length: ${newstring.length}`);
  console.log(`strings is ${strings}`);
  puker = JSON.stringify(newstring)
  console.log(`puker: ${puker}`);
  console.log(`puker length = ${puker.length}`);
  return strings[0]
}
...
//
// // forcounting = arr.map(n => JSON.stringify(n))
// forcounting = arr
//
// // console.log(arr);
// console.log(`original: ${arr}`);
// console.log(`for counting: ${forcounting}`);
//
// onelong = forcounting.join('')
// console.log(`onelong: ${onelong}`);
// console.log(`total code: ${onelong.length}`);
//
...
// console.log(`total strings: ${onelongstripped.length}`);
//
// console.log(JSON.stringify("a\b", repl));
//
// function repl(a, val) {
//   return val.replace(/\\\\/, '!')
// }
